...
class Balanced
{
  public:
          ...
          void Total_Control();
          void delayfor(int delay);

          void Motion_Control(Direction direction, int turnSpeed);
          void Stop();
          void Forward(int speed);
          void Back(int speed);
          void Left(int speed);
          void Right(int speed);
          void LeftThenBack(int turnSpeed, int speed);
          void RightThenBack(int turnSpeed, int speed);
          void LeftThenFollow(int turnSpeed, int speed);
          void RightThenFollow(int turnSpeed, int speed);
